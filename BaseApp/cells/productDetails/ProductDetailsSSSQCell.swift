...
class ProductDetailsSSSQCell: ProductDetailsCell {
    ...
    var option : Config? {
        didSet{
            ...
            self.radioBtn.isSelected = option.checked
        }
    }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        selectionStyle = .none
        [img , titleLbl , priceLbl , radioBtn].forEach { view in
        ...
        titleLbl.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(self.radioBtn.snp.leading).offset(-4)
        }
