...
class PlanEventTableViewCell: UITableViewCell {
    ...
    let img:UIImageView = {
        let img = UIImageView()
        img.image = UIImage(named: "plan_event")
        return img
    }()
    ...
    let titleLbl:C8Label = {
        ...
        lbl.text = "Plan an event".localized
    ...
    let subTitleLbl:C8Label = {
        let lbl = C8Label()
        lbl.text = "plan_event_sub_title".localized
