...
public class CodableHelper {
    ...
    public class func decode<T>(_ type: T.Type, from data: Data) -> (decodableObj: T?, error: Error?) where T : Codable {
    ...
    public class func encode<T>(_ value: T, prettyPrint: Bool = false) -> EncodeResult where T : Encodable {
