...
open class AMProgressBar: UIView {
    ...
    private var textLabel: C8Label? = nil
    ...
    private func configureStripesLayer() {
        ...
        for i in -1...stripesCount + 1 {
            ...
            let rect = CGRect(x:((stripesWidth) * CGFloat(i)), y: 0, width: stripesWidth, height: frame.height)
            ...
            if i % 2 == 0 {
                ...
                stripe.fillColor = UIColor.white.cgColor
            }
    ...
    private func updateProgress(animated: Bool) {
        guard let barLayer = barLayer, barMode_ != .undetermined else { 
            return
        }
